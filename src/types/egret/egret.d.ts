...
declare namespace egret {
     ...
     */
    class WebGLUtils {
        // static compileProgram(gl: any, vertexSrc: string, fragmentSrc: string): WebGLProgram;
        // static compileFragmentShader(gl: any, shaderSrc: string): WebGLShader;
        // static compileVertexShader(gl: any, shaderSrc: string): WebGLShader;
        // private static _compileShader(gl, shaderSrc, shaderType);
        // private static canUseWebGL;
        // static checkCanUseWebGL(): boolean;
        // static deleteany(any: any): void;
        /**
         * inspired by pixi.js
         */
...
declare namespace egret {
    ...
    class BitmapData extends HashObject {
         ...
         * HTMLImageElement|any|HTMLVideoElement
         * @version Egret 2.4
         * @platform Web,Native
         * @private
         * @language en_US
...
declare namespace egret.sys {
    ...
    let WebGLRenderContext: {
        //new(width?: number, height?: number, context?: any): RenderContext;
    };
}
/**
 * @private
...
declare namespace egret.sys {
     ...
     * 创建一个canvas。
     */
    function mainCanvas(width?: number, height?: number): any;
    ...
    * 获得系统的渲染运行时
    */
    function getContextWebGL(surface: any): any;
    function getContext2d(surface: any): CanvasRenderingContext2D;
    /**
    * 仅通过bitmapData创建纹理
    */
    function createTexture(renderContext: RenderContext, bitmapData: BitmapData | any): any;
    /**
    * 通过 width, height, data创建纹理
    */
    function _createTexture(renderContext: RenderContext, width: number, height: number, data: any): any;
    /**
     * 画texture
     **/
     ...
     * @param root
     */
    function createCanvasRenderBufferSurface(defaultFunc: (width?: number, height?: number) => any, width?: number, height?: number, root?: boolean): any;
    /**
     * 改变渲染缓冲的大小并清空缓冲区
     * @param renderContext
     * @param width
